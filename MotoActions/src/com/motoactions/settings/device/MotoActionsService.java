...
package com.motoactions.settings.device;
...
import com.motoactions.settings.device.actions.UpdatedStateNotifier;
import com.motoactions.settings.device.actions.CameraActivationSensor;
import com.motoactions.settings.device.actions.ChopChopSensor;
import com.motoactions.settings.device.actions.FlipToMute;
import com.motoactions.settings.device.actions.LiftToSilence;
import com.motoactions.settings.device.actions.ProximitySilencer;

import com.motoactions.settings.device.doze.DozePulseAction;
import com.motoactions.settings.device.doze.GlanceSensor;
import com.motoactions.settings.device.doze.ProximitySensor;
import com.motoactions.settings.device.doze.FlatUpSensor;
import com.motoactions.settings.device.doze.ScreenReceiver;
import com.motoactions.settings.device.doze.ScreenStateNotifier;
import com.motoactions.settings.device.doze.StowSensor;
